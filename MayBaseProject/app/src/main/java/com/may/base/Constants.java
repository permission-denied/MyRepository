...
public class Constants {
    ...
    public static String LOG_TAG_NAME_FOUR = "etcgame";
    public static String LOG_TAG_NAME_FIVE = "etcgame";
    public static String LOG_TAG_NAME_SIX = "etcgame";
    ...
    public static String LOG_TAG_NAME_ELVEN= "etcgame";
    public static String LOG_TAG_NAME_TWELVE= "etcgame";
    public static String LOG_TAG_NAME_THIRTEEN= "etcgame";
    public static String LOG_TAG_NAME_FOURTEEN= "etcgame";
    public static String LOG_TAG_NAME_FIFTEEN= "etcgame";
    ...
    public static class EventBusFlag {
        ...
        //模块二 10001-20000
        public static final int MSG_TWO = 10001;

        //模块三 20001-30000
        public static final int MSG_THREE = 20001;

        //模块四 30001-40000
        public static final int MSG_FOUR = 30001;
